...
class LazopClient
{
	...
	public function __construct($url = "", $appkey = "", $secretKey = "", $accessToken = "")
	{
		$length = strlen($url);
		if ($length == 0) {
	...
	protected function generateSign($apiName, $params)
	{
		...
		return strtoupper($this->hmac_sha256($stringToBeSigned, $this->secretKey , $this->accessToken));
	}
	...
	public function execute(LazopRequest $request )
	{
